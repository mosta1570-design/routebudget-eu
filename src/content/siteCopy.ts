...
const italian: SiteCopy = {
  ...
  resources: {
    ...
    items: [
      ...
      {
        kind: 'Guida Serbia 2026',
        title: 'Pedaggio camion Serbia',
        text: 'Distingui categoria III e IV, verifica tariffa, TAG e Toll4All prima di fissare il prezzo.',
        action: 'Verifica la Serbia',
        href: '/it/guide/pedaggio-camion-serbia-2026/',
      },
      {
        kind: 'Guida cargo',
        title: 'Traghetto camion Italia–Grecia',
        text: 'Leggi nolo, supplementi, dimensioni e tempi di check-in dentro una quotazione freight confrontabile.',
        action: 'Prepara il preventivo',
        href: '/it/guide/traghetto-camion-italia-grecia/',
      },
      {
        kind: 'Guida Polonia 2026',
        title: 'Pedaggio camion Polonia',
        text: 'Verifica rete e-TOLL, massa del complesso, classe EURO e importo in PLN senza usare una vignetta auto.',
        action: 'Calcola e-TOLL',
        href: '/it/guide/pedaggio-camion-polonia-2026/',
      },
    ],
...
const english: SiteCopy = {
  ...
  resources: {
    ...
    items: [
      ...
      {
        kind: 'Serbia 2026 guide · Italian',
        title: 'Truck tolls in Serbia',
        text: 'Separate categories III and IV, then verify tariff, TAG and Toll4All before pricing the trip.',
        action: 'Read in Italian',
        href: '/it/guide/pedaggio-camion-serbia-2026/',
      },
      {
        kind: 'Cargo guide · Italian',
        title: 'Italy–Greece truck ferry',
        text: 'Read freight, surcharges, dimensions and check-in time inside a comparable cargo quote.',
        action: 'Read in Italian',
        href: '/it/guide/traghetto-camion-italia-grecia/',
      },
      {
        kind: 'Poland 2026 guide · Italian',
        title: 'Truck tolls in Poland',
        text: 'Verify e-TOLL network, combination mass, EURO class and PLN amount without using a car vignette.',
        action: 'Read in Italian',
        href: '/it/guide/pedaggio-camion-polonia-2026/',
      },
    ],
