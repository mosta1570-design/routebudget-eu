...
const italian: SiteCopy = {
  ...
  nav: [
    ...
    { label: 'Guide', href: '/routebudget-eu/it/guide/' },
    ...
    items: [
      {
        ...
        href: '/routebudget-eu/it/guide/calcolo-costo-trasporto/',
      },
      {
        kind: 'Calcolatore',
        ...
        href: '/routebudget-eu/it/calcolatori/costo-chilometrico-camion/',
      },
      {
        kind: 'Calcolatore',
        ...
        action: 'Apri il calcolatore',
        href: '/routebudget-eu/it/calcolatori/costo-carburante-viaggio/',
      },
    ],
...
const english: SiteCopy = {
  ...
  nav: [
    ...
    { label: 'Guides', href: '/routebudget-eu/it/guide/' },
