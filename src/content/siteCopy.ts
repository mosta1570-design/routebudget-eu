...
const italian: SiteCopy = {
  ...
  resources: {
    ...
    items: [
      ...
      {
        kind: 'Guida Paesi Bassi 2026',
        title: 'Vrachtwagenheffing camion',
        text: 'Verifica OBU, massa, EURO, CO₂ e la finestra tariffaria dopo la fine dell’Eurovignetta.',
        action: 'Calcola il pedaggio',
        href: '/it/guide/pedaggio-camion-paesi-bassi/',
      },
      {
        kind: 'Guida Belgio 2026',
        title: 'Pedaggio Viapass',
        text: 'Separa Fiandre, Vallonia e Bruxelles; controlla classe CO₂ e importo prima dell’offerta.',
        action: 'Prepara il Viapass',
        href: '/it/guide/pedaggio-camion-belgio/',
      },
      {
        kind: 'Guida Slovenia 2026',
        title: 'Pedaggio DarsGo',
        text: 'Distingui DarsGo dalla vignetta e verifica sezioni, assi, EURO e CO₂ del camion.',
        action: 'Verifica DarsGo',
        href: '/it/guide/pedaggio-camion-slovenia/',
      },
    ],
...
const english: SiteCopy = {
  ...
  resources: {
    ...
    items: [
      ...
      {
        kind: 'Netherlands 2026 guide · Italian',
        title: 'Vrachtwagenheffing truck toll',
        text: 'Check OBU, mass, EURO, CO₂ and date-specific rates after the Eurovignette ended.',
        action: 'Read in Italian',
        href: '/it/guide/pedaggio-camion-paesi-bassi/',
      },
      {
        kind: 'Belgium 2026 guide · Italian',
        title: 'Viapass truck toll',
        text: 'Split Flanders, Wallonia and Brussels, then verify CO₂ class and total before pricing.',
        action: 'Read in Italian',
        href: '/it/guide/pedaggio-camion-belgio/',
      },
      {
        kind: 'Slovenia 2026 guide · Italian',
        title: 'DarsGo truck toll',
        text: 'Separate DarsGo from the vignette and verify sections, axles, EURO and CO₂ class.',
        action: 'Read in Italian',
        href: '/it/guide/pedaggio-camion-slovenia/',
      },
    ],
