...
const italian: SiteCopy = {
  ...
  resources: {
    ...
    items: [
      ...
      {
        kind: 'Guida pratica',
        title: 'Tempi di guida e riposo',
        text: 'Distingui guida, pause, riposi e altre attività prima di stimare durata e costo della tratta.',
        action: 'Pianifica il tempo',
        href: '/it/guide/tempi-guida-riposo-camion/',
      },
      {
        kind: 'Guida pratica',
        title: 'Costo orario dell’autista',
        text: 'Separa costo aziendale, retribuzione e prezzo usando metodo e riferimenti ufficiali 2026.',
        action: 'Calcola la voce lavoro',
        href: '/it/guide/costo-orario-autista-camion/',
      },
      {
        kind: 'Guida 2026',
        title: 'Attese al carico e scarico',
        text: 'Distingui franchigia, indennizzo, costo interno e condizioni prima del preventivo.',
        action: 'Proteggi il tempo',
        href: '/it/guide/tempi-attesa-carico-scarico-autotrasporto/',
      },
    ],
...
const english: SiteCopy = {
  ...
  resources: {
    ...
    items: [
      ...
      {
        kind: 'Guide · Italian',
        title: 'Truck driving and rest times',
        text: 'Separate driving, breaks, rests and other work before estimating trip duration and cost.',
        action: 'Read in Italian',
        href: '/it/guide/tempi-guida-riposo-camion/',
      },
      {
        kind: 'Guide · Italian',
        title: 'Truck driver hourly cost',
        text: 'Separate employer cost, take-home pay and customer price with current 2026 references.',
        action: 'Read in Italian',
        href: '/it/guide/costo-orario-autista-camion/',
      },
      {
        kind: '2026 guide · Italian',
        title: 'Loading and unloading waits',
        text: 'Separate grace period, compensation, internal cost and commercial terms before quoting.',
        action: 'Read in Italian',
        href: '/it/guide/tempi-attesa-carico-scarico-autotrasporto/',
      },
    ],
