...
const italian: SiteCopy = {
  ...
  resources: {
    ...
    items: [
      ...
      {
        kind: 'Guida Sicilia 2026',
        title: 'Costo traghetto camion Sicilia',
        text: 'Separa direzione, scaglione MTL, voci incluse e tempo prima di fissare il prezzo della missione.',
        action: 'Verifica il costo',
        href: '/it/guide/costo-traghetto-camion-sicilia/',
      },
      {
        kind: 'Guida Eurovignette 2026',
        title: 'Eurovignette camion',
        text: 'Controlla paese, durata, assi, EURO e CO₂; distingui il sistema dal pedaggio olandese al km.',
        action: 'Verifica l’Eurovignette',
        href: '/it/guide/eurovignette-camion-2026/',
      },
      {
        kind: 'Guida Repubblica Ceca 2026',
        title: 'Pedaggio MYTO CZ',
        text: 'Verifica rete, categoria, assi, EURO, CO₂ e dispositivo prima di attribuire il pedaggio alla tratta.',
        action: 'Prepara MYTO CZ',
        href: '/it/guide/pedaggio-camion-repubblica-ceca/',
      },
    ],
...
const english: SiteCopy = {
  ...
  resources: {
    ...
    items: [
      ...
      {
        kind: 'Sicily 2026 guide · Italian',
        title: 'Sicily truck ferry cost',
        text: 'Separate direction, MTL band, included charges and time before pricing the mission.',
        action: 'Read in Italian',
        href: '/it/guide/costo-traghetto-camion-sicilia/',
      },
      {
        kind: 'Eurovignette 2026 guide · Italian',
        title: 'Eurovignette for trucks',
        text: 'Check country, duration, axles, EURO and CO₂, keeping it separate from the Dutch kilometre toll.',
        action: 'Read in Italian',
        href: '/it/guide/eurovignette-camion-2026/',
      },
      {
        kind: 'Czech Republic 2026 guide · Italian',
        title: 'MYTO CZ truck toll',
        text: 'Verify network, category, axles, EURO, CO₂ and device before assigning toll cost to the route.',
        action: 'Read in Italian',
        href: '/it/guide/pedaggio-camion-repubblica-ceca/',
      },
    ],
