...
const italian: SiteCopy = {
  ...
  resources: {
    ...
    items: [
      ...
      {
        kind: 'Guida 2026',
        title: 'Tachigrafo per furgoni',
        text: 'Verifica soglia oltre 2,5 t, attività internazionale, G2V2 e impatto economico dal 1° luglio.',
        action: 'Controlla il perimetro',
        href: '/it/guide/tachigrafo-furgoni-2026/',
      },
      {
        kind: 'Guida MIT 2026',
        title: 'Tabelle costi autotrasporto',
        text: 'Scegli la classe A–D, usa solo le voci applicabili e confronta il benchmark con i tuoi dati.',
        action: 'Leggi le tabelle',
        href: '/it/guide/tabelle-costi-autotrasporto-mit-2026/',
      },
      {
        kind: 'Guida internazionale',
        title: 'Pedaggio camion in Austria',
        text: 'Prepara GO-Maut con assi, classi EURO e CO₂, Brennero e verifica ASFINAG.',
        action: 'Calcola senza sorprese',
        href: '/it/guide/pedaggio-camion-austria/',
      },
    ],
...
const english: SiteCopy = {
  ...
  resources: {
    ...
    items: [
      ...
      {
        kind: '2026 guide · Italian',
        title: 'Tachograph rules for vans',
        text: 'Check the 2.5 t threshold, cross-border scope, G2V2 and cost impact from 1 July.',
        action: 'Read in Italian',
        href: '/it/guide/tachigrafo-furgoni-2026/',
      },
      {
        kind: 'MIT 2026 guide · Italian',
        title: 'Official transport cost tables',
        text: 'Choose class A–D, apply only relevant rows and compare the benchmark with your own data.',
        action: 'Read in Italian',
        href: '/it/guide/tabelle-costi-autotrasporto-mit-2026/',
      },
      {
        kind: 'International guide · Italian',
        title: 'Truck tolls in Austria',
        text: 'Prepare GO-Maut using axles, EURO and CO₂ classes, Brenner sections and ASFINAG checks.',
        action: 'Read in Italian',
        href: '/it/guide/pedaggio-camion-austria/',
      },
    ],
