...
const italian: SiteCopy = {
  ...
  resources: {
    ...
    items: [
      ...
      {
        kind: 'Guida pratica',
        title: 'Quanto consuma un camion?',
        text: 'Misura i litri per 100 km con dati reali e trasforma il consumo in costo di tratta.',
        action: 'Calcola il consumo',
        href: '/it/guide/quanto-consuma-un-camion/',
      },
      {
        kind: 'Guida pratica',
        title: 'Calcolo del pedaggio camion',
        text: 'Leggi classe, assi, chilometri tariffari e limiti della stima prima di inserire il costo.',
        action: 'Verifica il metodo',
        href: '/it/guide/calcolo-pedaggio-camion/',
      },
      {
        kind: 'Guida N1',
        title: 'Costo furgone per km',
        text: 'Calcola costi fissi, variabili, ore e chilometri fatturabili senza applicare medie da camion.',
        action: 'Apri la guida N1',
        href: '/it/guide/costo-furgone-per-km/',
      },
    ],
...
const english: SiteCopy = {
  ...
  resources: {
    ...
    items: [
      ...
      {
        kind: 'Guide · Italian',
        title: 'How much fuel does a truck use?',
        text: 'Measure litres per 100 km from real records and convert consumption into a trip cost.',
        action: 'Read in Italian',
        href: '/it/guide/quanto-consuma-un-camion/',
      },
      {
        kind: 'Guide · Italian',
        title: 'How truck tolls are calculated',
        text: 'Understand class, axles, chargeable kilometres and the limits of an operational estimate.',
        action: 'Read in Italian',
        href: '/it/guide/calcolo-pedaggio-camion/',
      },
      {
        kind: 'N1 guide · Italian',
        title: 'Van cost per kilometre',
        text: 'Separate fixed, variable, time and billable-kilometre costs without reusing truck averages.',
        action: 'Read in Italian',
        href: '/it/guide/costo-furgone-per-km/',
      },
    ],
