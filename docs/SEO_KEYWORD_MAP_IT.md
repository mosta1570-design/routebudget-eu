...
| calcolo costo trasporto | I/C | Valutazione | pillar | `/it/guide/calcolo-costo-trasporto/` | come calcolare costo trasporto; costo tratta camion; formula costo trasporto; calcolo viaggio camion | Porta tutti i costi nel calcolo completo RouteBudget | generato nel build M1, deploy da verificare / P0 |
| costi autotrasporto | I | Scoperta | pillar | `/it/guide/costi-autotrasporto/` | costi impresa autotrasporto; voci di costo camion; costo esercizio camion; costi per tratta | Usa RouteBudget per attribuire i costi alla tratta | generato nel build M1, deploy da verificare / P0 |
| preventivo trasporto | I/C | Valutazione | pillar | `/it/guide/preventivo-trasporto/` | come fare preventivo trasporto merci; voci preventivo autotrasporto; prezzo tratta camion | Crea un preventivo PDF nell'app | generato nel build M1, deploy da verificare / P0 |
| calcolatore costo chilometrico camion | T | Decisione | calcolatore | `/it/calcolatori/costo-chilometrico-camion/` | calcolo costo camion al km; costo chilometrico autotrasporto; costo per chilometro camion; costo km bilico | Ottieni scenari e preventivo completi in RouteBudget | generato nel build M1, deploy da verificare / P0 |
| calcolatore costo carburante viaggio | T | Valutazione | calcolatore | `/it/calcolatori/costo-carburante-viaggio/` | calcolo gasolio camion; consumo camion per tratta; litri per 100 km; costo diesel viaggio | Aggiungi pedaggi, autista e usura nell'app | generato nel build M1, deploy da verificare / P0 |
| calcolare carburante, pedaggi e autista | I | Valutazione | guida | `/it/guide/calcolare-carburante-pedaggi-autista/` | formula carburante; pedaggi inseriti; costo orario autista; costo operativo tratta | Riunisci tutte le voci nel calcolo RouteBudget | generato nel build M1, deploy da verificare / P0 |
| costi fissi e variabili autotrasporto | I | Scoperta | guida | `/it/guide/costi-fissi-variabili-autotrasporto/` | differenza costi fissi variabili; ammortamento camion; assicurazione e bollo; costi diretti viaggio | Trasforma i costi aziendali in una quota per tratta | generato nel build M1, deploy da verificare / P0 |
| costo chilometrico camion | I | Valutazione | guida | `/it/guide/costo-chilometrico-camion/` | come calcolare costo al km; km percorsi e fatturabili; ritorno a vuoto; componenti costo/km | Applica il metodo nel calcolatore costo chilometrico | generato nel build M1, deploy da verificare / P0 |
| errori calcolo tariffa trasporto | I | Scoperta | guida | `/it/guide/errori-calcolo-tariffa-trasporto/` | costi dimenticati preventivo; tariffa troppo bassa; errori prezzo per km; pedaggi esclusi | Controlla tutte le voci con RouteBudget | generato nel build M1, deploy da verificare / P0 |
| proteggere margine della tratta | I/C | Decisione | guida | `/it/guide/proteggere-margine-tratta/` | margine eroso; ritorno a vuoto; costi non inclusi; verifica prezzo tratta | Verifica costo e scenari prima di accettare | generato nel build M1, deploy da verificare / P0 |
...
| pedaggi autostradali camion | I/C | Valutazione | pillar | `/it/guide/pedaggi-autostradali-camion/` | pedaggi mezzi pesanti; costo autostrada camion; classe pedaggio assi; verificare pedaggio camion | Inserisci o verifica il pedaggio nel calcolo RouteBudget | pianificato M3 / P1 |
| pedaggio camion assi peso classe | I | Scoperta | guida | `/it/guide/pedaggio-camion-assi-peso-classe/` | categorie pedaggio camion; numero assi pedaggio; massa veicolo tariffa; classe ambientale pedaggio | Prepara i dati del mezzo prima del calcolo | pianificato M3 / P1 |
| come verificare pedaggio camion | I | Valutazione | guida | `/it/guide/verificare-pedaggio-camion/` | calcolo pedaggio ufficiale; operatori autostradali; importo manuale pedaggio; stima vs tariffa | Riporta l'importo verificato in RouteBudget | pianificato M3 / P1 |
...
| costo furgone per km | I/T | Valutazione | guida N1 | `/it/guide/costo-furgone-n1-km/` | costo veicolo commerciale leggero; N1 costo viaggio; furgone carburante o energia; trailer leggero | Configura il veicolo corretto in RouteBudget | pianificato M5, verifica scope / P2 |
