...
assert.equal(counts.guide, 11, 'current set requires exactly eleven supporting guides');
...
console.log(`Content schema passed: ${published} published pages (3 pillars, 11 supports, 3 calculators, 1 app landing).`);
