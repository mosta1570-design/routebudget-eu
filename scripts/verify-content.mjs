...
assert.equal(counts.guide, 23, 'current set requires exactly twenty-three supporting guides');
...
console.log(`Content schema passed: ${published} published pages (3 pillars, 23 supports, 3 calculators, 1 app landing).`);
