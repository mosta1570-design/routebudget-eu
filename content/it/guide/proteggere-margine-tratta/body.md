...
1. **costo operativo**, cioè le risorse attribuite alla missione;
2. **punto di pareggio**, il prezzo che copre il modello adottato senza margine;
3. **prezzo proposto**, che aggiunge margine e considera le condizioni del servizio.
...
1. prezzo carburante di base e scenario superiore;
2. ritorno con carico confermato e ritorno a vuoto;
3. attesa ordinaria e attesa prolungata;
