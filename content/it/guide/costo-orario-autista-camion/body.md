...
Il trattamento economico e contrattuale di ogni fase deve essere verificato nel caso reale. Per il controllo della tratta, l’obiettivo è evitare che ore effettivamente assorbite scompaiano dal modello. La guida sui [tempi di guida e riposo](/it/guide/tempi-guida-riposo-camion/) aiuta a separare la pianificazione temporale, mentre l’approfondimento sulle [attese al carico e scarico](/it/guide/tempi-attesa-carico-scarico-autotrasporto/) distingue costo interno, franchigia e possibile indennizzo.
...
I 360 € sono la quota di costo autista dell’esempio, non il totale della tratta né una tariffa da presentare al cliente. Se diaria o trasferta sono già comprese nei 57.600 €, aggiungerle nuovamente crea un doppione; se sono escluse e la missione le genera, vanno registrate a parte.
...
Un costo orario ben costruito rende confrontabili tratte lunghe, distribuzione e servizi con molte soste. Non promette precisione assoluta, ma rende visibile il tempo che il solo costo per chilometro tende a nascondere. Per collocarlo dentro l’intero sistema economico, consulta la [mappa dei costi dell’autotrasporto](/it/guide/costi-autotrasporto/) e il [metodo completo per il costo della tratta](/it/guide/calcolo-costo-trasporto/).
