...
1. identifica veicolo, rimorchio o semirimorchio e relativa classe di peso;
2. seleziona solo componenti realmente presenti nella missione;
3. non sommare rimorchio e semirimorchio se ne utilizzi uno solo;
4. confronta ogni voce con i dati aggiornati della tua impresa;
5. calcola a parte distanza reale, ritorno a vuoto, ore, pedaggi della rotta e margine.

Il MIT ha pubblicato l’aggiornamento di marzo il **17 marzo 2026**. La pagina ufficiale specifica che, in questa versione, sono stati aggiornati assicurazione, energia e pedaggiamenti. Prima di una decisione economica va quindi controllata la [pagina MIT con i valori più recenti](https://www.mit.gov.it/documentazione/valori-indicativi-di-riferimento-dei-costi-di-esercizio-dellimpresa-italiana-di-6), perché una tabella successiva può sostituire il riferimento di marzo.
...
Nel [calcolatore costo chilometrico camion](/it/calcolatori/costo-chilometrico-camion/) puoi inserire dati della tua missione e vedere come le principali componenti incidono sul totale. RouteBudget combina carburante, pedaggi, costo autista, usura, ritorno a vuoto e margine, quindi può generare un preventivo PDF basato sugli input inseriti.
...
Per costruire tutte le componenti consulta la [mappa dei costi dell’autotrasporto](/it/guide/costi-autotrasporto/) e il [metodo completo di calcolo del trasporto](/it/guide/calcolo-costo-trasporto/). La guida sul [costo chilometrico camion](/it/guide/costo-chilometrico-camion/) chiarisce anche la differenza tra chilometri totali, produttivi e fatturati.
