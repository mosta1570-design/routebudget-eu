...
Separare queste voci rende più facile aggiornare il totale quando cambia soltanto una parte dell’itinerario. Per una missione da o per l'isola, la guida al [costo del traghetto camion in Sardegna](/it/guide/costo-traghetto-camion-sardegna/) mostra perché preventivo marittimo, costi terrestri e ritorno devono restare riconoscibili; per il solo Stretto usa invece il [costo traghetto camion Sicilia](/it/guide/costo-traghetto-camion-sicilia/) con direzione e tariffa corrente. Sul corridoio della Manica, il [costo traghetto camion Calais–Dover](/it/guide/costo-traghetto-camion-calais-dover-2026/) richiede un preventivo freight corrente e il controllo separato di BAF ed ETS.
...
Quando la richiesta cambia il modo di attribuire i costi, usa il metodo dedicato: [costo trasporto pallet](/it/guide/costo-trasporto-pallet/) per spazio e movimentazioni, [costo trasporto refrigerato](/it/guide/costo-trasporto-refrigerato/) per ore del gruppo frigo, [costo Traforo Monte Bianco camion](/it/guide/costo-traforo-monte-bianco-camion/) per classe e tariffa ufficiale.

Per rendere il calcolo verificabile nel tempo, separa [foglio Excel e versioni](/it/guide/calcolo-costi-trasporto-camion-excel/), [preventivo PDF](/it/guide/preventivo-trasporto-pdf/) e [tempi di pagamento dell'autotrasporto](/it/guide/tempi-pagamento-autotrasporto/); per un N1 verifica anche il [costo autostrada del furgone](/it/guide/costo-autostrada-furgone/).
