## Risposta diretta: dal costo al preventivo di trasporto
...
## Dal costo all’offerta di trasporto
...
1. **Testata.** Logo, dati dell’attività, contatti, numero e data.
2. **Destinatario.** Ragione sociale o referente indicato dal cliente.
3. **Oggetto.** Una riga che identifica servizio e tratta.
4. **Dettaglio operativo.** Ritiro, consegna, date, mezzo e attività comprese.
5. **Prezzo.** Importo ben visibile, valuta ed eventuale suddivisione utile.
6. **Condizioni della proposta.** Validità, ipotesi, esclusioni e passaggi successivi.
7. **Contatti e accettazione.** Canale per rispondere o chiedere una revisione.
...
Per rendere trasparente anche il passaggio interno, immaginiamo un costo operativo didattico di 1.000 €. Con un ricarico del 20% sul costo, lo scenario sarebbe 1.200 €. Con un margine del 20% sul prezzo finale, il calcolo sarebbe invece `1.000 ÷ 0,80 = 1.250 €`. Prima di riportare l’importo nel preventivo, aggiungi o escludi soltanto le voci previste dal tuo processo e controlla che la convenzione percentuale sia dichiarata internamente.
...
RouteBudget genera un riepilogo non vincolante della stima con le informazioni operative disponibili nel flusso e il prezzo dello scenario scelto. Il dettaglio dei costi può essere incluso quando l’opzione è disponibile; il logo aziendale è una funzione Pro. Controlla sempre la versione installata e la scheda ufficiale dello store prima di basare il processo su un campo specifico.
...
1. bozza interna, ancora modificabile;
2. proposta inviata, con data e versione;
3. servizio confermato secondo il processo adottato dall’impresa.
