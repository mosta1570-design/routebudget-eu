...
L’[articolo 14 della legge 51/2022 pubblicato in Gazzetta Ufficiale](https://www.gazzettaufficiale.it/eli/gu/2022/06/03/128/so/22/sg/pdf) ha inserito la clausola carburante fra gli elementi essenziali dell’articolo 6 e ha aggiunto il comma 6-bis per i rapporti non scritti. L’[articolo 83-bis riportato in Gazzetta Ufficiale](https://www.gazzettaufficiale.it/eli/gu/2023/10/06/234/sg/pdf) conserva inoltre una previsione specifica per le prestazioni oltre trenta giorni.
...
Per i contratti conclusi in forma non scritta, l’articolo 6, comma 6-bis, indica che il corrispettivo si determina in base ai valori indicativi di riferimento dei costi di esercizio pubblicati e aggiornati dal MIT. CNA FITA, nel suo [richiamo operativo del 18 marzo 2026](https://modena.cna.it/fuel-surcharge-cosa-prevede-la-normativa/), distingue infatti le rilevazioni mensili MASE per i contratti scritti dai valori MIT per quelli non scritti.
...
1. data di sottoscrizione e periodo in cui devono essere eseguite le prestazioni;
2. punto del contratto o delle fatture del primo mese che identifica la quota carburante;
3. ultimo adeguamento realmente effettuato e relativo valore base.
...
1. **Blocca la versione contrattuale.** Conserva documento firmato, data certa, allegati e modifiche accettate.
2. **Registra la base.** Salva mese, valore, unità, URL e data di acquisizione; annota se deriva dalla stipula o dall’ultimo adeguamento.
3. **Acquisisci il confronto.** Scarica o archivia il valore mensile dalla stessa serie MASE. Evita screenshot senza intestazione o periodo.
4. **Controlla confrontabilità.** Stesso prodotto, unità, perimetro fiscale e frequenza.
5. **Misura la soglia.** Calcola la variazione con più decimali; arrotonda solo nel punto previsto.
6. **Applica la regola documentata.** Usa base del corrispettivo e incidenza già definite, senza aggiungere voci estranee.
7. **Fai approvare il prospetto.** Indica chi lo ha preparato, chi lo ha verificato e quale contratto riguarda.
8. **Comunica il risultato.** Condividi periodo, fonte, base precedente, variazione e decorrenza; non inviare solo il totale.
9. **Allinea fattura e registro.** La descrizione deve permettere di risalire al prospetto e all’ordine interessato.
10. **Aggiorna il riferimento.** Se l’adeguamento viene effettuato, registra il nuovo valore base per il controllo successivo.
...
Per rifare l’aritmetica con i tuoi valori usa il [calcolatore fuel surcharge per autotrasporto](/it/calcolatori/fuel-surcharge-autotrasporto/). Il calcolatore mostra un risultato matematico: non decide se esiste un obbligo, non interpreta il contratto e non autorizza un addebito.
...
Nell’aprile 2026 FIAP ha pubblicato una circolare dal titolo esplicito: [“I 100 milioni del Governo non sostituiscono la clausola contrattuale”](https://www.fiapautotrasporti.it/le-ultime-notizie/fuel-surcharge-come-calcolarla-e-come-farla-valere-i-100-milioni-del-governo-non-sostituiscono-la-clausola-contrattuale/). È una posizione associativa, non una sentenza sul tuo contratto. Distingue però due piani che non vanno compensati a voce:
