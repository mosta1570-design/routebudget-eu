...
1. il dato omologato, utile per confrontare versioni in condizioni standard;
2. il consumo reale misurato sul proprio furgone e su missioni comparabili;
3. il consumo prudente da usare per il viaggio futuro.

Il terzo nasce dal secondo, non da una cifra trovata online. Questa guida riguarda consumo ed energia della singola missione. Per un mezzo pesante usa invece il metodo su [quanto consuma un camion](/it/guide/quanto-consuma-un-camion/), perché configurazione e scala sono diverse. Il [costo completo del furgone per km](/it/guide/costo-furgone-per-km/) comprende anche mezzo, assicurazione, manutenzione, lavoro e altre spese: i due risultati non vanno confusi.
...
1. rifornisci fino a un livello ripetibile e registra odometro, data e veicolo;
2. svolgi la missione senza perdere i chilometri non fatturati;
3. al pieno successivo registra litri e chilometri percorsi;
4. calcola `litri ÷ km × 100`;
5. classifica il risultato per percorso, carico e allestimento.
...
- calcola `kWh acquistati ÷ km × 100` per il costo energetico osservato.
...
Includi sempre andata, rientro, trasferimento al primo ritiro, deviazioni ragionevoli e accessi. La guida sul [ritorno a vuoto](/it/guide/ritorno-a-vuoto-autotrasporto/) mostra perché chilometri non fatturati restano chilometri consumati.

## Inserire il consumo in RouteBudget senza attribuirgli funzioni inesistenti

Nel profilo N1 di [RouteBudget per autotrasportatori](/it/app-per-autotrasportatori/) puoi scegliere diesel, benzina, GPL, CNG o elettrico e inserire consumo e prezzo nell'unità prevista: l/100 km e €/l per diesel, benzina o GPL; kg/100 km e €/kg per CNG; kWh/100 km e €/kWh per l'elettrico. Il profilo ibrido o personalizzato richiede invece una verifica esterna. Distanza e ritorno a vuoto trasformano il dato supportato in una stima di missione; pedaggi, autista e usura restano componenti distinte.
...
Questa separazione è utile: consumo risponde a “quanta energia servirà”; la guida ai [costi dell'autotrasporto](/it/guide/costi-autotrasporto/) risponde a “quanto costa svolgere il lavoro”. Solo dopo si decide il prezzo commerciale.
